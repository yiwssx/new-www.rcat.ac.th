...
> Manual production smoke verification completed against https://preview-placeholder.example.invalid/. All manual smoke checks were confirmed as passed.
...
- Local quality gate passed and manual production smoke verification passed against https://preview-placeholder.example.invalid/.
