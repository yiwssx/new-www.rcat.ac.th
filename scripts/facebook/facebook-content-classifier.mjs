...
const CATEGORY_RULES = [
  {
    ...
    signals: [
      [14, /จัดซื้อจัดจ้าง|ประกวดราคา|ราคากลาง|e[- ]?bidding|สอบราคา/iu, "procurement-explicit"],
      [14, /ประกาศผู้ชนะการเสนอราคา|ผู้ชนะการเสนอราคา|วิธีเฉพาะเจาะจง/iu, "procurement-award"],
      [8, /จัดซื้อ|จัดจ้าง|เสนอราคา|ใบเสนอราคา/iu, "procurement-keyword"]
    ]
  },
  {
    category: "ITA/คุณธรรมและความโปร่งใส",
    signals: [
      [14, /\bITA\b|\bOIT\b/iu, "ita-acronym"],
      [13, /การประเมินคุณธรรมและความโปร่งใส|เปิดเผยข้อมูลสาธารณะ/iu, "ita-explicit"],
      [9, /ป\.ป\.ช\.?|ต่อต้านการทุจริต|ป้องกันการทุจริต|จริยธรรม/iu, "integrity-keyword"],
  ...
  },
  {
    ...
    signals: [
      ...
      [12, /รับสมัคร|เปิดรับสมัคร|สมัครเรียน|รับลงทะเบียน|เปิดรับลงทะเบียน/iu, "application"],
      [12, /รายชื่อผู้มีสิทธิ|รายชื่อผู้ผ่าน|ผลการคัดเลือก|ผลการสอบ|ประกาศผล/iu, "result-notice"],
      [9, /กำหนดการ|แจ้งกำหนด|แจ้งให้ทราบ|ประชาสัมพันธ์รับสมัคร/iu, "notice"],
      [6, /ประกาศ|แจ้ง|รายชื่อ|เชิญชวน/iu, "announcement-general"]
    ]
  },
  {
    category: "ผลงานและรางวัล",
    signals: [
      [14, /ได้รับรางวัล|คว้ารางวัล|รับรางวัล|มอบรางวัล/iu, "award-explicit"],
      [14, /ชนะเลิศ|รองชนะเลิศ|รางวัลชนะเลิศ|รางวัลดีเด่น/iu, "award-placement"],
      [10, /ได้รับคัดเลือก|ผ่านการคัดเลือก.*ระดับ|ผลงานดีเด่น/iu, "achievement"],
      [4, /ผลงาน|รางวัล/iu, "achievement-general"],
  ...
  },
  {
    ...
    signals: [
      [12, /ฝึกอบรม|การอบรม|อบรมเชิงปฏิบัติการ|ประชุมเชิงปฏิบัติการ/iu, "training-explicit"],
      [10, /สัมมนา|workshop/iu, "seminar"],
      [8, /โครงการอบรม|โครงการพัฒนา|โครงการส่งเสริม|โครงการยกระดับ/iu, "project-explicit"],
      [5, /โครงการ/iu, "project-general"],
      [4, /พัฒนาศักยภาพ|พัฒนาทักษะ|ศึกษาดูงาน/iu, "development"]
    ]
  },
  {
    category: "กิจกรรม",
    signals: [
      [11, /จัดกิจกรรม|กิจกรรมเนื่องใน|กิจกรรมวัน/iu, "activity-explicit"],
      [9, /เข้าร่วมกิจกรรม|ร่วมกิจกรรม/iu, "activity-participation"],
      [9, /พิธีเปิด|พิธีปิด|พิธีถวาย|พิธีทำบุญ|พิธีลงนาม/iu, "ceremony"],
      [8, /ต้อนรับ|ลงพื้นที่|เยี่ยมชม|เยี่ยมบ้าน|จิตอาสา|บริการวิชาชีพ/iu, "activity-action"],
      [7, /ประชุม|เข้าร่วมประชุม/iu, "meeting"],
      [5, /เข้าร่วมการแข่งขัน|เข้าร่วมประกวด|ส่งนักเรียน.*แข่งขัน|ส่งนักศึกษา.*แข่งขัน/iu, "competition-participation"],
...
const HARD_OVERRIDES = [
  ...
  [
    "ประกาศ",
    /รับสมัคร|เปิดรับสมัคร|รายชื่อผู้มีสิทธิ|รายชื่อผู้ผ่าน|ผลการคัดเลือก|ผลการสอบ|ประกาศผล/iu,
    "hard-announcement"
  ]
];

const TAG_RULES = [
  ["รับสมัคร", /รับสมัคร|เปิดรับสมัคร|สมัครเรียน|รับลงทะเบียน/iu],
  ["สมัครงาน", /รับสมัครงาน|รับสมัคร.*พนักงาน|ลูกจ้างชั่วคราว|พนักงานราชการ|ลูกจ้าง/iu],
  ...
  ["ทุนการศึกษา", /ทุนการศึกษา|ทุนเรียน/iu],
  ["แนะแนว", /แนะแนว|ประชาสัมพันธ์หลักสูตร/iu],
...
const GENERIC_HASHTAGS = new Set(
  ...
  ].map((value) => value.toLocaleLowerCase("th-TH"))
);
...
function resolveConfidence(top, second) {
  ...
  if (top.score >= 12 && margin >= 5) return 0.97;
  if (top.score >= 10 && margin >= 4) return 0.94;
  if (top.score >= 8 && margin >= 3) return 0.9;
  if (top.score >= 6 && margin >= 2) return 0.84;
  if (top.score >= 4 && margin >= 2) return 0.77;
  if (top.score >= 2) return 0.67;
  return 0.58;
}
